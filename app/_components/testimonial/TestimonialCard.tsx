...
const TestimonialCard: React.FC<TestimonialCardProps> = ({
  ...
  return (
    <div className="bg-white rounded-xl shadow-md flex flex-col justify-between max-h-[300px] min-h-[300px] space-y-4 max-w-xs md:max-w-sm md:w-full mx-auto p-4 sm:p-6 h-full text-center mt-4 sm:mt-0">

  ...
  return (
    <div className="min-h-screen bg-gray-100 py-12 px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white p-8 shadow-lg rounded-lg">
        ...
        <p className="text-gray-700 mb-4">
          We collect information about your interactions with our Site and services, including IP addresses, browser types, pages visited, and the dates and times of your visits.
        </p>
        <h3 className="text-xl font-semibold text-gray-900 mb-2">1.3 Cookies and Tracking Technologies:</h3>
        <p className="text-gray-700 mb-4">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-2">2.2 To Improve Our Services:</h3>
        <p className="text-gray-700 mb-4">
          Usage data helps us understand how our Site is used, enabling us to improve our offerings and user experience.
        </p>
        <h3 className="text-xl font-semibold text-gray-900 mb-2">2.3 For Marketing:</h3>
        <p className="text-gray-700 mb-4">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-2">3.2 Legal Requirements:</h3>
        <p className="text-gray-700 mb-4">
          We may disclose your information if required by law or to comply with legal processes, respond to governmental requests, or protect our rights and safety.
        </p>
        <h3 className="text-xl font-semibold text-gray-900 mb-2">3.3 Business Transfers:</h3>
        <p className="text-gray-700 mb-4">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-2">5.3 Opt-Out:</h3>
        <p className="text-gray-700 mb-4">
